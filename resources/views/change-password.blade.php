                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('update-password') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="oldPassword" type="text" placeholder="Clave Actual"
                        ...
                        <div class="mb-3">
                            ...
                            <input name="newPassword" type="text" placeholder="Clave Nueva"
                        ...
                        <div class="mb-3">
                            ...
                            <input name="newPassword_confirmation" type="text" class="form-control" placeholder="Confirmar Clave">
                        </div>
